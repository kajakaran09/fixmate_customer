...
export default function SplashScreen() {
    ...
    useEffect(() => {
        ...
        // Optional: Auto-navigate after some time if this were a real splash
    ...
    return (
        <View style={styles.container}>
            ...
            >
                {/* Status Bar Placeholder (Visual only, for layout matching) */}
                <View style={styles.statusBarPlaceholder}>
                    {/* Actual status bar is handled by expo-status-bar */}
                </View>
...
const styles = StyleSheet.create({
    ...
    title: {
        ...
        letterSpacing: 0.5,
        marginBottom: 8,
        // fontFamily: 'Poppins-Bold' // utilizing system font weight instead
    },
    tagline: {
        fontSize: 15,
